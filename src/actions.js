...
export const EDIT_SINGLE_PRODUCT_SUCCESS = 'EDIT_SINGLE_PRODUCT_SUCCESS'
export const EDIT_SINGLE_PRODUCT_ERROR = 'EDIT_SINGLE_PRODUCT_ERROR'
...
export const GET_INGREDIENTS_BEGIN = 'GET_INGREDIENTS_BEGIN'
export const GET_INGREDIENTS_SUCCESS = 'GET_INGREDIENTS_SUCCESS'
export const GET_INGREDIENTS_ERROR = 'GET_INGREDIENTS_ERROR'
export const GET_SUBCATEGORIES_BEGIN = 'GET_SUBCATEGORIES_BEGIN'
